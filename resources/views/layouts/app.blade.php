...
<head>
    ...
    @if (file_exists(public_path('build/manifest.json')) || file_exists(public_path('hot')))
        @safeVite(['resources/css/app.css', 'resources/css/bundles/admin.css', 'resources/js/app.js'])
    @endif
...
<body>
    ...
    <div class="sidebar">
        ...
        <nav class="sidebar-nav">
            <a href="{{ route('admin.dashboard') }}" data-turbo-prefetch class="@if(Route::currentRouteName() === 'admin.dashboard') active @endif">
            ...
            <a href="{{ route('admin.productos.index') }}" data-turbo-prefetch class="@if(str_starts_with(Route::currentRouteName(), 'admin.productos') || str_starts_with(Route::currentRouteName(), 'admin.products')) active @endif">
                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" class="icon-18">
            ...
            <a href="{{ route('admin.categorias.index') }}" data-turbo-prefetch class="@if(str_starts_with(Route::currentRouteName(), 'admin.categorias')) active @endif">
                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" class="icon-18">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z"></path>
                </svg>
                Categorias
            </a>
            <a href="{{ route('admin.zonas.index') }}" data-turbo-prefetch class="@if(str_starts_with(Route::currentRouteName(), 'admin.zonas')) active @endif">
                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" class="icon-18">
            ...
            <a href="{{ route('admin.proveedores.index') }}" data-turbo-prefetch class="@if(str_starts_with(Route::currentRouteName(), 'admin.proveedores')) active @endif">
                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" class="icon-18">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21H5a2 2 0 01-2-2V5a2 2 0 012-2h11l5 5v11a2 2 0 01-2 2z"></path>
                </svg>
                Proveedores
            </a>
            <a href="{{ route('admin.guardias.index') }}" data-turbo-prefetch class="@if(str_starts_with(Route::currentRouteName(), 'admin.guardias')) active @endif">
                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" class="icon-18">
            ...
            <a href="{{ route('admin.diccionario.index') }}" data-turbo-prefetch class="@if(str_starts_with(Route::currentRouteName(), 'admin.diccionario')) active @endif">
                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" class="icon-18">
            ...
            @if (Auth::check() && Auth::user()->isSuperAdmin())
                <a href="{{ route('admin.users.index') }}" data-turbo-prefetch class="@if(str_starts_with(Route::currentRouteName(), 'admin.users')) active @endif">
                    <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" class="icon-18">
            ...
            @endif
            <a href="{{ route('shop.home') }}" data-turbo-prefetch class="sidebar-divider-link">
                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" class="icon-18">
