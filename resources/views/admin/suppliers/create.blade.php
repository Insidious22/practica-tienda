...
<div class="admin-form-container">
    <form action="{{ route('admin.proveedores.store') }}" method="POST" class="admin-form-card">
        @csrf
        ...
        <div class="admin-form-group">
            ...
            <input type="text" name="business_name" value="{{ old('business_name') }}" required class="admin-form-input">
            @error('business_name')
                <span class="admin-form-error">{{ $message }}</span>
            @enderror
        </div>
        ...
        <div class="admin-form-group">
            ...
            <input type="text" name="trade_name" value="{{ old('trade_name') }}" class="admin-form-input">
            @error('trade_name')
                <span class="admin-form-error">{{ $message }}</span>
            @enderror
        </div>
        ...
        <div class="admin-form-group">
            ...
            <input type="text" name="contact_name" value="{{ old('contact_name') }}" class="admin-form-input">
            @error('contact_name')
                <span class="admin-form-error">{{ $message }}</span>
            @enderror
        </div>
        ...
        <div class="admin-form-grid">
            <div>
                ...
                <input type="email" name="email" value="{{ old('email') }}" class="admin-form-input">
                @error('email')
                    <span class="admin-form-error">{{ $message }}</span>
                @enderror
            </div>
        ...
        <div class="admin-form-group">
            ...
            <input type="text" name="address" value="{{ old('address') }}" class="admin-form-input">
            @error('address')
                <span class="admin-form-error">{{ $message }}</span>
            @enderror
        </div>
        ...
        <div class="admin-form-grid">
            <div>
                ...
                <input type="text" name="city" value="{{ old('city') }}" class="admin-form-input">
                @error('city')
                    <span class="admin-form-error">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div>
                ...
                <input type="text" name="tax_id" value="{{ old('tax_id') }}" class="admin-form-input">
                @error('tax_id')
                    <span class="admin-form-error">{{ $message }}</span>
                @enderror
            </div>
        ...
        <div class="admin-form-group">
            ...
            <input type="text" name="payment_terms" value="{{ old('payment_terms') }}" class="admin-form-input">
            @error('payment_terms')
                <span class="admin-form-error">{{ $message }}</span>
            @enderror
        </div>
        ...
        <div class="admin-form-group">
            ...
            <textarea name="notes" rows="3" class="admin-form-textarea">{{ old('notes') }}</textarea>
            @error('notes')
                <span class="admin-form-error">{{ $message }}</span>
            @enderror
        </div>
        ...
        <div class="admin-form-group admin-form-group--lg">
            ...
            <select name="status" required class="admin-form-select">
                @foreach($statusOptions as $statusOption)
                    <option value="{{ $statusOption->siglas }}" {{ old('status', 'ACT') === $statusOption->siglas ? 'selected' : '' }}>
